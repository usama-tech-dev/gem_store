...
import 'package:gem_store/feature/auth/forgot_password/presentation/forgot_password.dart';
import 'package:gem_store/feature/auth/login/widget/login_methods.dart';
import 'package:gem_store/feature/auth/signup/presentation/signup.dart';
import 'package:gem_store/feature/dashboard/presentation/dashboard.dart';
              ...
              Column(
                children: [
                  AppButton(
                      title: 'Login',
                      onTap: () {
                        Navigate.to(context, DashboardPage());
                      }),
                  SizedBox(height: 22),
                  Text(
                    'or log in with',
